...
import com.S2013.dcc.fragment.ActionItemDetailFrag;
import com.S2013.dcc.fragment.ActionItemFrag;
import com.S2013.dcc.fragment.AdminSearchFragment;
import com.S2013.dcc.fragment.CreateActionItemFrag;
import com.S2013.dcc.fragment.MemberDetailFragment;
import com.S2013.dcc.fragment.MembersListFragment;
import com.S2013.dcc.fragment.MenuFragment;
import com.S2013.dcc.fragment.NewsDetailFragment;
import com.S2013.dcc.fragment.NewsListFragment;
import com.S2013.dcc.fragment.TopFragment;
...
public class MainActivityFrag extends FragmentActivity implements OnButtonSelectedListener{
    ...
    /**ID of left fragment*/
    private static final int LEFT_FRAG = R.id.fragmentcontainerleft;
    /**ID of right fragment*/
    private static final int RIGHT_FRAG = R.id.fragmentcontainerright;
    /**ID of top fragment*/
    private static final int TOP_FRAG = R.id.fragmentcontainerbottom;
    private Fragment menu, main, top;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null){
            ...
            transaction.add(TOP_FRAG,top);

            transaction.commit();
        }

        if(!Storage.menuHidden){
    ...
    public void onBackPressed(){
        if(!Storage.menuHidden) displaySide();
        else
        {
