...
import com.S2013.dcc.EasterEggs;
import com.S2013.dcc.R;
import com.S2013.dcc.Zork;
...
public class MenuFragment extends Fragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(Storage.getUser().getName().equalsIgnoreCase("sam bevins")
                || Storage.getUser().getName().equalsIgnoreCase("robert williams")){
            ...
            view = inflater.inflate(R.layout.menu_fragment,
                    container, false);
            Button searchN = (Button)view.findViewById(R.id.menu_search);
            searchN.setOnClickListener(this);
            director = true;
        }
